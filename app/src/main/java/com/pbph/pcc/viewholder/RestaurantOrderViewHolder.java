...
public class RestaurantOrderViewHolder extends ViewHolder {
    ...
    protected void showView() {
        GetUserStoreBean.DataBean.TakeoutListEntityBean vo = (GetUserStoreBean.DataBean.TakeoutListEntityBean) item;

        textView1.setText(vo.getStoreName());


        textView21.setText("月售");
        textView21.append(vo.getSales());
        textView21.append("单");
        ...
        Glide.with((Fragment) adapter.activity).load(vo.getStoreImg()).placeholder(R.mipmap.banner_zw).error(R.mipmap.banner_zw).into(imageView1);
