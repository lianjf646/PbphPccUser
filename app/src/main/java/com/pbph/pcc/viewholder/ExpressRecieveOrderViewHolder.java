...
public class ExpressRecieveOrderViewHolder extends ViewHolder {
    ...
    protected int getLayout() {
        return R.layout.listview_express_recieve_order;
    }
    ...
    protected void showView() {
        ...
        textView22.setText(vo.getGetAddressName());
        textView33.setText(vo.getSendAddressName());

        textView44.setText(vo.getGettingAmount() + "元");

//        textView5.setText(vo.getDinnerAmount());
//        textView55.setText(vo.getDinnerAmount());
