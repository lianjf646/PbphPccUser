...
public class CommissionRecieveRecordOrderViewHolder extends ViewHolder {
    ...
    protected int getLayout() {
        return R.layout.listview_commission_recieve_record_order;
    }
    ...
    protected void showView() {
        ...
        textView33.setText(vo.getTaskAddressDetail());
