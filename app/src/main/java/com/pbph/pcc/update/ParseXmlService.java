        ...
        try {
            ...
            for (int j = 0; j < childNodes.getLength(); j++) {
                ...
                if (childNode.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    if ("must".equals(childElement.getNodeName())) {
                        hashMap.put("must", childElement.getFirstChild()
                                .getNodeValue());
                    }
                    ...
                    if ("version".equals(childElement.getNodeName())) {
                        ...
                        hashMap.put("url", childElement.getFirstChild()
                                .getNodeValue());
                    } else if (("kb".equals(childElement.getNodeName()))) {
                        hashMap.put("kb", childElement.getFirstChild()
                                .getNodeValue());
